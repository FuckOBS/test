# VERSION: 1.0
# ORIGINAL AUTHORS: LightDestory (https://github.com/LightDestory)
KNABEN is the best torrent index fr
...
debug = os.environ.get("DEBUG_KNABEN", "") != ""
...
class knaben(object):
    ...
    class Parser:
            ...
            for torrent in collection:
                if "magnet" in torrent:
                    ...
                    if btih:
                        ...
                        # never reached? knaben returns only v1 torrents
        ...
        def get_token(self, force_update=False):
            ...
            cache_path = self.cache_dir + "/knaben.token.txt"
